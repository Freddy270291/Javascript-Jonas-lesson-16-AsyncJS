...
/*
// PROMISE.RACE()
// It receives an array of promises and returns a Promise.
// The Promise returned is settled as soon as one of the input Promises is settled (value available, rejected or fulfilled)
...
(async function () {
  ...
  console.log(res[0]); // It gives the fastest result
})();

// PROMISE.ALLSETTLED (ES2020)
// The promise.All returns an array of all the settled Promises, it never shortcircuit
Promise.allSettled([
...
// PROMISE.ANY (ES2021)
// It will return the first fulfilled promise (rejected promises are ignored)
